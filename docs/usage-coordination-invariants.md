...
| Fresh 5h remaining usage, or weekly remaining usage when 5h is unknown, clears a quota cooldown and restores selection | `account-manager.test.ts` quota reconciliation tests |
